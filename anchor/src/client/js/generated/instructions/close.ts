...
export type CloseInput<
  ...
  TAccountCertfront extends string = string,
> = {
...
>(
  input: CloseInput<TAccountPayer, TAccountCertfront>,
  config?: { programAddress?: TProgramAddress }
): CloseInstruction<TProgramAddress, TAccountPayer, TAccountCertfront> {
  // Program address.
  ...
  const instruction = {
    accounts: [
      ...
      getAccountMeta(accounts.certfront),
    ],
    programAddress,
    data: getCloseInstructionDataEncoder().encode({}),
  } as CloseInstruction<TProgramAddress, TAccountPayer, TAccountCertfront>;
